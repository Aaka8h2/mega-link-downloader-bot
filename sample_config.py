...
class Config(object):
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8063262449:AAFWJmaSgIdu2-27etCkt8X-lT6Y-OJV6o4") # Make a bot from https://t.me/BotFather and enter the token here
    #If deploying on vps edit the above value as example := TG_BOT_TOKEN = "Your-bot-token-inside-inverted-commas."
    
    APP_ID = int(os.environ.get("APP_ID", 29199850)) # Get this value from https://my.telegram.org/apps
    #If deploying on vps edit the above value as example := APP_ID = Your-APP_ID-without-inverted-commas
    
    API_HASH = os.environ.get("API_HASH", "711c12d4f9bb08a1342715862e4df9c9") # Get this value from https://my.telegram.org/apps
    ...
    Bot_username = os.environ.get("Bot_username", "@File_storea_bot") # Your bot's telegram username (must enter with '@' in the front of the username)
